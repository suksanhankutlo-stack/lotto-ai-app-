...
class AISystem:
    ...
    def analyze(self, X_train, y_train, X_next, pos, data_hash, sample_weight=None):  
        ...
        if not os.path.exists(model_path):  
            ...
            try: 
                ...
                try:
                    ...
                    # ป้องกัน Error หากคลาสข้อมูลในประวัติมีไม่ครบ 0-9
        ...
        # ป้องกันกรณี predict_proba คืนค่าคลาสไม่ครบ 10 ตัว
        for c, p in zip(self.model.classes_, probs): 
            res[int(c)] = p  
            
        # ถ้าไม่มีการพยากรณ์ให้กระจายค่าแบบ Uniform
        if res.sum() == 0:
            res = np.ones(10) / 10
            ...
            for i in range(bt_size):  
                ...
                try: 
                    ...
                    try:
                        ...
                        # Fallback ข้ามการ Calibrate กรณีคลาสตัวเลขไม่ครบ
